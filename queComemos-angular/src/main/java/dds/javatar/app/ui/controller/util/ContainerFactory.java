...
public class ContainerFactory {
	...
	private RepositorioRecetas instanceRepositorioRecetas = RepositorioRecetas
		.getInstance();
	private RepositorioUsuarios instanceRepoUsuarios = RepositorioUsuarios
		.getInstance();
	...
	public void agregarRecetasAlRepositorio() {
		...
		instanceRepositorioRecetas.agregar(pure);
		...
		instanceRepositorioRecetas.agregar(milanesas);
		...
		instanceRepositorioRecetas.agregar(souffleVegano);
		...
		instanceRepositorioRecetas.agregar(tartaEspinaca);
		...
		instanceRepositorioRecetas.agregar(mousseChocolate);
		...
		instanceRepositorioRecetas.agregar(arrolladoPrimavera);
		...
		instanceRepositorioRecetas.agregar(sandwitch);
		...
		instanceRepositorioRecetas.agregar(ensaladaPobretona);
		...
		instanceRepositorioRecetas.agregar(flan);
		...
		instanceRepositorioRecetas.agregar(papasFritas);
	}
	...
	public void agregarUsuariosAlRepo() {
		...
		maru.marcarFavorita(instanceRepositorioRecetas.recetaConocidas.get(0));
		maru.marcarFavorita(instanceRepositorioRecetas.recetaConocidas.get(1));
		maru.marcarFavorita(instanceRepositorioRecetas.recetaConocidas.get(2));
