...
public class RecetaSimple implements Cloneable,Receta {
...
//	private Set<Receta> subRecetas;
	...
	public RecetaSimple(Integer calorias) {
		this();
		this.calorias = calorias;
	}
	
	public RecetaSimple(Integer calorias, TipoReceta tipo){
		this(calorias);
		this.setTipo(tipo);
	}
	...
	//	Esto quedaria en blanco ? O hay q tirar una excepcion?
	}
	...
	@Override
	public Receta clone() {
		RecetaSimple recetaClonada = new RecetaSimple();
