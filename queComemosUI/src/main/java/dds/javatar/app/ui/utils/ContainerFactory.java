...
public class ContainerFactory {
	...
	private RepositorioRecetas instanceRepositorio = RepositorioRecetas
			.getInstance();
	...
	public void agregarRecetasAlRepositorio() {
		...
		Receta pure = new RecetaBuilder("Pure").totalCalorias(350)
				...
				.inventadaPor("Mariano").dificultad("FACIL").temporada("Otoño")
				...
				.agregarPaso(4, "Mezclar").buildReceta();
		...
		Receta milanesas = new RecetaBuilder("Milanesa de Pollo")
				...
				.agregarPaso(1,
						"Rebozar las supremas con huevo revuelto y pan rallado.")
				.agregarPaso(2, "Hornear durante 25 minutos.")
				.agregarPaso(3, "Decorar con hojas de laurel.")
				.inventadaPor("ElSiscador").dificultad("FACIL")
				.temporada("Todo el año").buildReceta();
		...
		Receta souffleVegano = new RecetaBuilder("Souffle Vegano")
				...
				.agregarPaso(1,
						"Hervir la calazaba hasta que se pueda deshacer con el tenedor.")
				.agregarPaso(2,
						"Ligar con la mayonesa de girasol, el aceite y la levadura hidratada.")
				...
				.inventadaPor("Maru Botana").dificultad("MEDIA")
				.temporada("Primavera").buildReceta();
		...
		Receta tartaEspinaca = new RecetaBuilder("Tarta de Espinaca")
				...
				.dificultad("MEDIA").inventadaPor("Cocineros Argentinos")
				.temporada("Invierno").buildReceta();
		...
		Receta mousseChocolate = new RecetaBuilder("Mousse de Chocolate")
				...
				.agregarPaso(2,
						"Agregar el huevo batido y el polvo de la gelatina sin sabor.")
				.agregarPaso(3, "Batir hasta lograr consistencia de espuma.")
				.agregarPaso(4,
						"Colocar en molde y dejar enfriar en heladera (Evitar el freezer).")
				...
				.dificultad("FACIL").temporada("Todo el año").buildReceta();
		...
		Receta arrolladoPrimavera = new RecetaBuilder("Arrollado Primavera")
				...
				.agregarPaso(
						1,
						"Desenrollar el pionono sobre una superficie plana donde no se haje y untarlo con una fina capa de mayonesa.")
				.agregarPaso(2, "Cubrirlo con las fetas de queso y jamón.")
				.agregarPaso(3,
						"Cortar el tomate en juliana y agregar las tiritas.")
				.agregarPaso(4, "Enrollar con cuidado y servir frío.")
				.dificultad("MEDIA").temporada("Verano").buildReceta();
		...
		Receta sandwitch = new RecetaBuilder("Sanguchitos de jamón y queso")
				...
				.agregarPaso(1,
						"Untar las dos rodajas de pan con el/los condimento(s) deseado(s).")
		...
		Receta ensaladaPobretona = new RecetaBuilder("Ensalada Simple")
				...
				.agregarIngrediente("Huevo", new BigDecimal(80))
				.inventadaPor("Mariano").dificultad("FACIL")
				.temporada("Primavera")
				.agregarCondimento("Sal", new BigDecimal(12))
				...
				.agregarPaso(5, "Mezclar").buildReceta();
		...
		Receta flan = new RecetaBuilder("Flan de Sobrecito Light")
				...
				.agregarPaso(1,
						"Hervir la leche junto con la mezcla de prepararación hasta conseguir espuma.")
		...
		Receta papasFritas = new RecetaBuilder("Papas fritas")
				...
				.agregarPaso(1,
						"Cortar las papas en rodajas y luego en bastones.")
				.agregarPaso(2,
						"Calentar el aceite en un sartén hasta que hierva.")
				.agregarPaso(3, "Freír las papas hasta que se doren.")
				.agregarPaso(4, "Retirar, dejar secar y enfriar.")
				.agregarPaso(5, "Condimentar con sal a gusto.").buildReceta();
	...
	public void agregarUsuariosAlRepo() {
		...
		instanceRepoUsuarios.add(maru);

		maru.marcarFavorita(instanceRepositorio.recetaConocidas.get(0));
		maru.marcarFavorita(instanceRepositorio.recetaConocidas.get(1));
		maru.marcarFavorita(instanceRepositorio.recetaConocidas.get(2));
    ...
    instanceRepoUsuarios.add(mariano);
    ...
    instanceRepoUsuarios.add(siscate);
